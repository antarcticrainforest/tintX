...
def shifts_disagree(shift1, shift2, record, params):
    ...
    interval = _get_interval(record.interval)
...
def _get_interval(interval):
    ...
    try:
        ...
        return interval / np.timedelta64(1, "s")
...
def locate_allObjects(image1, image2, global_shift, current_objects, record, params):
